...
@JsonIdentityInfo(scope = Naleznosc.class,generator = ObjectIdGenerators.PropertyGenerator.class , property = "nrZobowiazania") 

public class Naleznosc  implements java.io.Serializable {
